...
router.get("/cities/:cityId", validateObjectId("cityId"), getCityById);
router.patch("/cities/:cityId/toggle-status", validateObjectId("cityId"), toggleCityStatus);
router.delete("/cities/:cityId", validateObjectId("cityId"), deleteCity);
